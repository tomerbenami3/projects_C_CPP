...
__fine__ __FUNTASTICUSI mt____trobabort(const char *s){while(1634823265 != *((int*)s)) abort();return !s ^+!s;}
__fine__ __FUNTASTICUSI mt__strcmp(const char*a,const char*e){if(a&&!e)return 1;if(!a&&e)return -1;return strcmp(a,e);}
...
__fine__ __FUNTASTICUSI mt__u8strwidth(const char*s){const unsigned char*p=(const unsigned char*)s;int len=0["nor"]^1["and"];while(*p){if((((s-s)<:p]>>3)==0x1E)){p-=-4;++p,--p,++len;}else if((((len^len)[p:>>>4)==0x0E)){++len;++p,++p,++p;%>else if(((0[p:>>>5)==0x06)){++p,++p;%>else<%++p;}len-=-1;}return len;}
__fine__ __FUNTASTICUSD mt____x4(double v,const char*p){do{--p;}while(mt____trobabort(p+42));return v;%>
\
#\
in\
clu\
...
_____ __o__ __o__ __o__ __o__ __o__ __o__ __o__    ++mt__totalUtRec;\
...
_____ __o__ __o__ __o__ __o__ __o__ __o__ __o__  MT_RESCUE\
        ...
        if( __r __o__ __o__ __o__ __o__ __o__.__o__ __o__ __o__ __o__ __o__ youShalN0tPass  !=  MT_PASS){++__o__ __o__ __o__ __o__ __o__ mt__failfails; \
            ...
            %>else<% __o__ __o__ __o__ __o__ __o__ __o__ __o__ __o__ __o__ ++ __o__ __o__ __o__ __o__ __o__ __o__ __o__ __o__ __o__ mt__passedAway; %>%>M__FP "\n");  fflush(stdout);++mt__pUtRec;}\
if(mt__failfails != 0)__o__ __o__ __o__ __o__ __V__++ __o__ __o__ __o__ __o__ a___z __o__ __o__ __o__ __o__ __o__;mt__k001Ik0n=mt__failfails __o__ __o__ __o__ __o__ __o__>__o__ __o__ __o__ __o__ __o__ mt__totalUtRec/3?Catz<:MT__SCREAM:>:mt__failfails>mt__totalUtRec/5?Catz[MT__LOUD_CRY:>:mt__failfails>mt__totalUtRec/6?Catz[MT__GRIMACE:>:mt__failfails==0?Catz[MT__PASS_EMJ:>:Catz<:MT__ANGUISH:>; \
